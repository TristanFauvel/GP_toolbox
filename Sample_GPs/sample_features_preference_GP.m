function [phi_pref, dphi_pref_dx, phi, dphi_dx] = sample_features_preference_GP(theta, D, model, approximation)
%% SSGP : Method based on the Sparse-Spectrum GP, Lazaro-Gredilla 2010
%% RRGP: Method based on the Reduced-Rank GP, Solin 2019
[phi, dphi_dx] = sample_features_GP(theta, D, model, approximation);
