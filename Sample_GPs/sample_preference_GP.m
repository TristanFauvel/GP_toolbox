...
[sample_g, dsample_g_dx, decomposition] = sample_value_GP_precomputed_featuressample_value_GP_precomputed_features(approximation, theta, xtrain_norm, ctrain, model, post);
